    ...
    public SecurityFilterChain filterChainMpa(final HttpSecurity http, final ClientRegistrationRepository clientRegistrationRepository,
        ...
        http
                ...
                .authorizeHttpRequests(authorizationManagerRequestMatcherRegistry -> {
                    authorizationManagerRequestMatcherRegistry.requestMatchers("/", "/web", "/web/home", "/login/oauth2/code/**", "/login").permitAll();
                    authorizationManagerRequestMatcherRegistry.requestMatchers("/web/**").authenticated();
                ...
                .exceptionHandling(httpSecurityExceptionHandlingConfigurer ->
                        httpSecurityExceptionHandlingConfigurer.accessDeniedPage("/web/403"));
        return http.build();
    }
