package thapo.pocspring.application.rest.public_api.stream;
...
public class StreamController {
    ...
    public static final String PATH_FETCH_STREAM = "/fetch_stream";
    public static final String PATH_FETCH_SSE = "/fetch_sse";

    @GetMapping(path = PATH_FETCH_STREAM, produces = MediaType.TEXT_PLAIN_VALUE)
    ...
    @GetMapping(path = PATH_FETCH_SSE, produces = MediaType.TEXT_EVENT_STREAM_VALUE)
