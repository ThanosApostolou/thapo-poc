package thapo.pocspring.application.web.todo;
...
import thapo.pocspring.application.rest.api.todo.CreateTodoAction;
import thapo.pocspring.application.rest.api.todo.DeleteTodoAction;
import thapo.pocspring.application.rest.api.todo.FetchTodosAction;
import thapo.pocspring.application.web.WebController;
...
public class TodoPageController {
    public static final String PATH = WebController.PATH + "/todo";
